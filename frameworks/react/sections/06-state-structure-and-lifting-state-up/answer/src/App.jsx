...
export default function App(){
 ...
 return <div className="container"><h1>06 状态提升（答案）</h1><div className="row"><CInput value={c} onChange={setC}/><FInput value={f} onChange={(v)=>setC(((Number(v)-32)*5/9).toFixed(1))}/></div></div>;
}
